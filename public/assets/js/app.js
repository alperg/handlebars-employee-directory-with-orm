  ...
  $("#exampleModal").on("show.bs.modal", function (event) {
    ...
    if(type === "update") {
      ...
      $.ajax(`/api/employees/${id}`, {
        ...
        modal.find(".modal-title").text("Update " + data[0].firstName);

        modal.find(".modal-body input#firstName").val(data[0].firstName);
        modal.find(".modal-body input#lastName").val(data[0].lastName);
        modal.find(".modal-body input#email").val(data[0].email);
        modal.find(".modal-body input#gender").val(data[0].gender);
        modal.find(".modal-body input#department").val(data[0].department);
        modal.find(".modal-body input#startDate").val(data[0].startDate);
